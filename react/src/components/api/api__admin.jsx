...
export const getInstructorsRequests = async () => {
  try {
    const response = await api.get('/admin/instructors/pending-application');
    console.log(response.data)
    return response.data;
  } catch (error) {
    console.error('Failed to fetch Requests instructors:', error);
    throw error;
  }
};
export const acceptInstructorRequest = async (id ) => {
  try {

    const response = await api.post(`admin/instructors/pending-application/${id}/accept`);
    return response.data;
  } catch (error) {
    console.error('Failed to accept instructor:', error);
    throw error;
  }
};
export const refuseInstructorRequest = async (id ) => {
  try {

    const response = await api.post(`admin/instructors/pending-application/${id}/refuse`);
    return response.data;
  } catch (error) {
    console.error('Failed to refuse instructor:', error);
    throw error;
  }
};
/******Page Students*/
export const getSubscribers = async () => {
  try {
    const response = await api.get('admin/client/subscriber');
    return response.data;
  } catch (error) {
    console.error('Failed to fetch instructors:', error);
    throw error;
